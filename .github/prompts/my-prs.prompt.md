---
name: my-prs
description: "Dashboard of your open PRs — review status, CI, merge state, reactions, release context, and what needs attention"
agent: pr-review
tools:
  - github/*
  - createFile
...
${input:filter:Optional: repo name, 'needs review', 'approved', 'failing CI', or keywords}

## Behavior

Parse the filter:
- **Repo name** → scope to that repo
