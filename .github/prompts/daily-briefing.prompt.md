---
name: daily-briefing
description: "Generate your daily GitHub briefing — issues, PRs, releases, discussions, reactions, accessibility updates, and action items in dual markdown + HTML format"
...
${input:scope:Optional: 'morning', 'afternoon update', 'weekly', specific repo, or 'just PRs' / 'just issues'}

## Behavior

Interpret the scope:

- **No input / "morning"** → full briefing covering the last 24 hours across all repos
