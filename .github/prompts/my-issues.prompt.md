---
name: my-issues
description: "Smart issue dashboard — lists your open issues sorted by priority with activity signals, reactions, release context, and discussion links"
agent: issue-tracker
tools:
  - github/*
  - createFile
...
${input:filter:Optional: repo name, date range, labels, or keywords}

## Behavior

Parse the filter text:
- **Repo name** → scope search to that repo
...
If no filter is provided, default to issues updated in the **last 30 days**.
