...
- [The Agents](#the-agents)
  ...
  - [VS Code Accessibility Tracker](#vs-code-accessibility-tracker)
...
| **Accessibility tracking** | WCAG/ARIA cross-referenced change tracking across VS Code and any repo you configure |
...
This agent monitors accessibility changes across VS Code (both Insiders and Stable builds) and any other repositories you point it at. But it goes beyond just listing closed issues.
...
Edit `.github/agents/preferences.md` and the agents learn about your team — who reviews what, how you prefer to merge, what labels matter, which repos to watch closely, and when your working day starts. You set it up once, and every agent inherits that knowledge from then on.
...
### Configurable Repos
You can track accessibility in any repository:
```
@insiders-a11y-tracker track a11y in my-org/my-repo
...
| `insiders-a11y-tracker.agent.md` | A11y Tracker agent | Accessibility tracking with WCAG/ARIA cross-references and configurable repos |
